...
def puzzle_input_part_1
  @puzzle_input_part_1 ||= input_file_to_hash(INPUT_FILE)
end
...
def part_one
  ...
  puts "Part 1: Illegal Character Point Sum: #{sum_illegal_character_values}"
end
...
def puzzle_input_part_two
  @puzzle_input_part_two ||= input_file_to_hash(INPUT_FILE)
end
...
def part_two
  ...
  puts "Part 2: Legal Character Point Sum: #{middle_legal_character_values_score}"
end
